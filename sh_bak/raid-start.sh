...
(sudo crontab -l; echo "*/30 * * * * /opt/exporter/raid-nvme.sh > /var/lib/node_exporter/textfile_collector/smartctl.prom") | sudo crontab -
bash /opt/exporter/raid-nvme.sh > /var/lib/node_exporter/textfile_collector/smartctl.prom